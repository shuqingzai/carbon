...
func TestCarbon_DiffInDuration(t *testing.T) {
	...
	t.Run("valid time", func(t *testing.T) {
		...
		assert.Equal(t, "696h0m0s", now.Copy().SubMonthsNoOverflow(1).DiffInDuration(now).String())
...
func TestCarbon_DiffAbsInDuration(t *testing.T) {
	...
	t.Run("valid time", func(t *testing.T) {
		...
		assert.Equal(t, "696h0m0s", now.Copy().SubMonthsNoOverflow(1).DiffAbsInDuration(now).String())
